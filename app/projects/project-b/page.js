        ...
        <div className="m-12 md:m-24 min-h-screen">
            ...
            <div className="my-16 flex flex-col md:grid grid-cols-4 gap-8">
                ...
                <div className="flex flex-col items-center md:items-end gap-1 col-start-4">
                    ...
                    <a className="text-teal-600 font-bold text-xl" href="https://simmer.io/@raymozou/project-b" target="_blank">Demo</a>
                    <a className="text-teal-600 font-bold text-xl" href="https://github.com/RaymoZou/project-b" target="_blank">Github</a>
                </div>
                <div className="flex flex-col md:col-span-full gap-4">
                    <h1 className="text-4xl font-semibold text-center md:text-left">Media</h1>
                    <img className="max-w-4xl" src="/project-b1.png" />
                </div>
                <div className="flex flex-col col-span-2 gap-4">
                    <h1 className="text-4xl font-semibold text-center md:text-left">Development</h1>
                    <p className="text-lg">
